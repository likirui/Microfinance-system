...
if($_SESSION['db_type'] == 2) $fileSQL = 'database/smartsacco_test.sql';
else $fileSQL = 'database/smartsacco_fresh.sql';
...
<html>
	...
	<body>
		<div class="content_center">
			<img src="ico/smartsacco_l.png" style="width:380px; margin-top:3em; margin-bottom:2em;"/>
